...
- **כרטיסיית מחשבונים**: מסה מולרית (כולל הידרטים), מאזן משוואות, המרות מסה/חומר/חלקיקים, אחוזי הרכב, ריכוזים שונים, pH/pOH/Ka/Kb, טבלת ICE, אנתלפיית תגובה (מקובץ נתונים), נוסחה אמפירית/מולקולרית ועוד.
